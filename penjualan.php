                        ...
                        <div class="card-body">
                            <table class="table table-hover table-bordered" id="mytable" style="margin-top: 10px">
                                ...
                                <?php
                                    ...
                                    $hasil = $proses->tampil_data_penjualan('penjualan',$sesi['IdPenjualan']);
                                    foreach($hasil as $isi){
                                ?>
                                    <tr>
                                        <td><?php echo $no; ?></td>
                                        <td><?php echo $isi['IdPenjualan']?></td>
                                        <td><?php echo $isi['JumlahPenjualan'];?></td>
                                        <td><?php echo $isi['HargaJual'];?></td>
                                        <td><?php echo $isi['IdPengguna'];?></td>
                                        <!--
